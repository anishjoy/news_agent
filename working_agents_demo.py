"""Working demonstration of OpenAI Agents SDK with real data collection."""
...
class WorkingNewsAgentSystem:
    def __init__(self, config_path='config.yaml'):
        """Initialize the working news agent system."""
    ...
    def create_system_agent(self) -> Agent:
        ...
        return Agent(
            name="Working News System Agent",
            instructions=f"""
    ...
    def run_full_pipeline(self):
        ...
        try:
            logger.info("Starting Working News Agent System with OpenAI Agents SDK")
        ...
        if results['success']:
            ...
            if 'collected_news' in results:
                ...
                for company, articles in results['collected_news'].items():
                    logger.info(f"  {company}: {len(articles)} articles")
